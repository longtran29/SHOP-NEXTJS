...
export default function Authenticate() {
  ...
  useEffect(() => {                             // destroy error: must have bracket
      ...
      <div className="w-full h-screen border-l-2 p-6 flex items-stretch">
        <div className="self-start mt-20 flex flex-col items-center gap-5">
          ...
          <p>
            ...
            history. Just fill in the fields below, and will get a new account
            set up for you in no time. We will only ask you for information
            necessary to make the purchase process faster and easier.
          </p>
          <button className="bg-black text-white p-2 w-1/4"> REGISTER</button>
        </div>
      </div>
      <ToastContainer />
    </div>
