...
const BootstrapDialog = styled(Dialog)(({ theme }) => ({
  ...
  // localLocale.locale('es');
    ...
    console.log("List imports " + JSON.stringify(imports));
        ...
        {imports ? (
          ...
          >
            ...
            <DialogContent dividers>
              ...
              <h6>Import date : {moment(selectedImport.import_Date).format("lll")}</h6>

              <h6><i>By: {selectedImport.account.username} </i></h6>
              </div>

              <Table columns={Importcolumns} pagination={{
